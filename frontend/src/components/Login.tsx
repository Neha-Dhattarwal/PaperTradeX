...
const Login: React.FC<LoginProps> = ({ onSuccess, onSwitchToSignup }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const dummyUser = { id: '1', email, name: 'Trader Pro' };
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-black text-white tracking-tighter mb-2">PaperTrade<span className="text-blue-500">X</span></h1>
          <p className="text-slate-500 font-medium">Precision practice for real-world trading.</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-2xl">
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center">
            ...
            >
              Don't have an account? <span className="text-blue-400 font-bold">Create one</span>
            </button>
          </div>
        </div>
      </div>
