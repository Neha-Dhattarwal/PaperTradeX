...
export const WATCHLIST: StockInfo[] = [
  { symbol: 'INFY.NS', name: 'Infosys Limited', lastPrice: 0, change: 0 },
  { symbol: 'RELIANCE.NS', name: 'Reliance Industries', lastPrice: 0, change: 0 },
  { symbol: 'TCS.NS', name: 'Tata Consultancy Services', lastPrice: 0, change: 0 },
  { symbol: 'AAPL', name: 'Apple Inc.', lastPrice: 0, change: 0 },
  { symbol: 'BTC-USD', name: 'Bitcoin', lastPrice: 0, change: 0 },
];
